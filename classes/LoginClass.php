<?php
	...
	class LoginClass
	{
		...
		*/
		...
		{
			$to = $post['emailadres'];
			$subject = "Activatiemail Jelle.";
			$message = "Geachte heer/mevrouw <b>".$post['naam']."</b><br>";
			$message .= '<style>a { color:red;}</style>';
			$message .= "Hartelijk dank voor het registreren bij Jelle Videotheek."."<br>";
			$message .= "klik <a href='http://localhost/Videotheek_einde/Videotheek/index.php?content=activate&email="."&emailadres=".$post['emailadres']."&wachtwoord=".$wachtwoord."'>hier</a> om uw account te activeren"."<br>";
